...
}; //random number untuk id kata

let data = fs.readFileSync('./wordlist.json', 'UTF-8')
let parse = JSON.parse(data)
let currentWord = parse[getRandom(1, 10)].word //jawaban
let shuffle = shuffleWord(currentWord) //hasil shuffle 
...
module.exports = { getRandom, shuffleWord, checkAnswer, getScore, currentWord, shuffle }